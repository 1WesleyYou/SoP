...
\newcommand{\schoolShort}{UIUC\xspace}
\newcommand{\school}{University of Illinois Urbana-Champaign\xspace}
\newcommand{\schoolLong}{University of Illinois Urbana-Champaign\xspace}
...
\paragraph{Fit with \schoolShort{} Computer Science and Future Goals.}
\schoolShort{} Computer Science is strong in systems, networking, and ML systems, and it aligns with my goal of building reliable infrastructure for large-scale ML. I am particularly interested in working with \textbf{Prof.~Francis~Y.~Yan}. His OSDI 25 work on \textbf{Decouple and Decompose (DeDe)}~\cite{10.5555/3767901.3767923} shows how to scale resource allocation by decoupling entangled constraints and decomposing the problem into parallel subproblems. This principle is deeply aligned with my OrderLab experience building safe, closed-loop mitigation for ZooKeeper: I want to bring structural decomposition to reliability and resource control by turning global SLO objectives into coordinated local controllers with explicit guardrails, and validating them under realistic failures and workload shifts.

I am also excited about \textbf{Prof.~Fan~Lai}'s work on practical GenAI systems, especially \textbf{HyGen}~\cite{sun2025hygenefficientllmserving}, which studies efficient LLM serving by elastically co-locating latency-sensitive online requests with throughput-oriented offline workloads while preserving SLOs. My experience building telemetry-driven mitigation interfaces and evaluating them under injected faults positions me to contribute to his projects by designing interference-aware control hooks (what to measure and when to act) and implementing lightweight runtime guardrails that protect tail latency while improving cluster utilization.
