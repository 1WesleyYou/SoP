...
\paragraph{Fit with \schoolShort{} GSAS Computer Science and Future Goals.}
NYU GSAS Computer Science is strong in systems, networking, and ML systems, and it aligns with my goal of building reliable infrastructure for large-scale ML. I am particularly interested in working with \textbf{Prof.~Aurojit~Panda}. In \textbf{Ellsberg}, his runtime monitors check real implementations against protocol specifications to surface safety violations. I want to adapt this style of specification-driven monitoring as a guardrail for agentic ZooKeeper mitigation, validating candidate actions before they affect the control plane.
I am also excited about \textbf{Prof.~Jinyang~Li}'s work on \textbf{Pensieve}, which tackles stateful LLM serving under tight resource and tail-latency budgets. This aligns with my GPU inference runtime work and motivates queueing-aware control hooks for multi-tenant serving.
